<x-guest-layout>
    ...
    <div class="font-sans">
      <div class="relative h-90 min-h-screen flex flex-col sm:justify-center items-center bg-gray-100 ">
        ...
        <div class="mt-4">
            ...
            <div class="mt-6 flex items-center justify-between">
                <form action="" method="post">
                    @csrf
                    <button type="submit" class="w-1/2 block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-1 border border-gray-300">
                    <div class="pt-2">
